...
*/
Pr[<=50000; 70000] ( <> ( has_osa ) )\


/*
True positive diagnoses
*/
Pr[<=50000; 70000] (<> ( Dhas_osa && has_osa ))\


/*
False negative diagnoses
*/
Pr[<=50000; 70000] ( <> ( has_osa && Dno_osa ) )\


/*
True negative diagnoses
*/
Pr[<=50000; 70000] ( <> ( no_osa && Dno_osa ) )\


/*
False positive diagnoses  [4]
*/
Pr[<=50000; 70000] ( <> ( no_osa && Dhas_osa ) )\


/*
Total cost of diagnosis [5]
*/
E[<=50000; 70000] (max:TOTAL_COST)\


/*
Time to diagnosis [6]
*/
E[<=50000; 70000] (max:DiagnosisTimer.total)\


/*
Percentage of patients receiving treatment [7]
*/
Pr[<=50000; 70000] ( <> ( TreatmentTimer.total>0 ) )\
...
*/
Pr[<=50000; 70000] ( <> ( otherTreatment>0 ) )\


/*

*/
Pr[<=50000; 70000] ( <> ( startFinalTreatment>0 ) )\
